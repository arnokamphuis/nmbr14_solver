...
# start = State([7,6,4,8,10,25], 419, [])
# start = State([9,6,7,8,3,100], 255, [])
# start = State([4,8,7,7,25,25], 579, [])
# start = State([2,5,3,9,50,25], 479, [])
# start = State([6,9,9,8,5,3], 275, [])
# start = State([9,2,7,6,50,25], 702, [])
# start = State([1,7,8,9,1,75], 654, [])
# start = State([10,2,5,3,7,10], 234, [])
